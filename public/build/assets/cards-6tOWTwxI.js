const _=window.__APP__,g=[{key:"like",emoji:"👍",label:"Like",color:"#2563EB"},{key:"love",emoji:"❤️",label:"Love",color:"#F43F5E"},{key:"haha",emoji:"😆",label:"Haha",color:"#F59E0B"},{key:"wow",emoji:"😮",label:"Wow",color:"#F59E0B"},{key:"sad",emoji:"😢",label:"Sad",color:"#F59E0B"},{key:"angry",emoji:"😡",label:"Angry",color:"#EF4444"}],f=Object.fromEntries(g.map(e=>[e.key,e])),i=e=>String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;");function y(e){return e?`${_.urls.profileBase}/${encodeURIComponent(e)}`:"#"}function L(e){if(!e)return"";const t=Date.parse(e);if(Number.isNaN(t))return"";const s=Math.max(0,Date.now()-t),a=6e4,n=60*a,o=24*n;if(s>=5*o)return"";if(s<a)return"just now";if(s<n)return`${Math.floor(s/a)} min ago`;if(s<o)return`${Math.floor(s/n)} hr ago`;const r=Math.floor(s/o);return`${r} day${r===1?"":"s"} ago`}function x(e){if(!e||e[0]!=="#")return!0;const t=e.length===4?e.slice(1).split("").map(o=>o+o).join(""):e.slice(1,7),s=parseInt(t.slice(0,2),16),a=parseInt(t.slice(2,4),16),n=parseInt(t.slice(4,6),16);return(s*299+a*587+n*114)/1e3>=160}function C(e){const t=y(e==null?void 0:e.username),s=e!=null&&e.id?`data-user-id="${e.id}"`:"";if(e!=null&&e.profile_picture)return`<a href="${t}" ${s} data-user-link><img class="avatar" src="${i(e.profile_picture)}" alt=""></a>`;const a=i(((e==null?void 0:e.username)||(e==null?void 0:e.name)||"U").charAt(0).toUpperCase());return`<a href="${t}" ${s} data-user-link><span class="avatar">${a}</span></a>`}function p(e,t,s){const a=e.user||{},n=i(a.name||a.username||"User"),o=i(L(e.created_at_iso)),r=Number(e.views_count||0).toLocaleString(),l=y(a.username),d=a.id?`data-user-id="${a.id}"`:"";return`
    <div class="post-head">
      ${C(a)}
      <div class="who">
  ...
  `}function S(e){const t=!!e.is_owner,s=!!e.saved,a=[];return t||(a.push(m("not_interested","Not interested","Show fewer posts like this",M())),a.push(m("hide","Hide post","Remove from your feed",j()))),a.push(`
  ...
  `),t&&(a.push('<div class="post-menu-sep"></div>'),a.push(m("edit","Edit post","Update your post content",A())),a.push(m("delete","Delete post","Permanently remove this post",P(),"is-danger"))),`
  ...
  `}function M(){return'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><line x1="4.93" y1="4.93" x2="19.07" y2="19.07"/></svg>'}function j(){return'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17.94 17.94A10.94 10.94 0 0 1 12 20c-7 0-11-8-11-8a19.77 19.77 0 0 1 4.22-5.06"/><path d="M1 1l22 22"/><path d="M9.9 4.24A10.94 10.94 0 0 1 12 4c7 0 11 8 11 8a19.5 19.5 0 0 1-3.13 4.18"/><path d="M14.12 14.12A3 3 0 1 1 9.88 9.88"/></svg>'}function E(e){return`<svg viewBox="0 0 24 24" fill="${e?"currentColor":"none"}" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M19 21l-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z"/></svg>`}function A(){return'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></svg>'}function P(){return'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="3 6 5 6 21 6"/><path d="M19 6l-1 14a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2L5 6"/><path d="M10 11v6"/><path d="M14 11v6"/><path d="M9 6V4a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2v2"/></svg>'}function T(){return`
    ...
    </div>`}function $(e){return(e||[]).slice(0,3).map(s=>{var a;return`<span class="re-chip">${((a=f[s])==null?void 0:a.emoji)||"👍"}</span>`}).join("")}function B(){return'<svg class="re-default" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M7 10v12"/><path d="M15 5.88 14 10h5.83a2 2 0 0 1 1.92 2.56l-2.33 8A2 2 0 0 1 17.5 22H4a2 2 0 0 1-2-2v-8a2 2 0 0 1 2-2h2.76a2 2 0 0 0 1.79-1.11L12 2a3.13 3.13 0 0 1 3 3.88Z"/></svg>'}function v(e){const t=Number(e.likes_count||0),s=Number(e.comments_count||0),a=e.my_reaction?f[e.my_reaction]:null;return`
  ...
  `}function K(e,t,s){if(!t)return;const a=s?f[s]:null;t.classList.toggle("is-reacted",!!a),t.setAttribute("aria-pressed",a?"true":"false"),t.dataset.reaction=a?a.key:"";const n=t.querySelector(".re-emoji");n&&(n.textContent=a?a.emoji:"");const o=t.querySelector("[data-like-label]");o&&(o.textContent=a?a.label:"Like",o.style.color=a?a.color:"")}function W(e,t){const s=e==null?void 0:e.querySelector("[data-likes-count]");s&&(s.textContent=t>0?Number(t).toLocaleString():""),H(e)}function G(e,t){const s=e==null?void 0:e.querySelector("[data-reaction-stack]");s&&(s.innerHTML=$(t))}function H(e){var n,o;const t=e==null?void 0:e.querySelector(".post-counts");if(!t)return;const s=(((n=t.querySelector("[data-likes-count]"))==null?void 0:n.textContent)||"").trim(),a=(((o=t.querySelector("[data-comment-count]"))==null?void 0:o.textContent)||"").trim();t.toggleAttribute("hidden",!s&&!a)}function F(e){e&&(e.classList.remove("is-open"),e.contains(document.activeElement)&&document.activeElement.blur(),e.classList.add("is-dismissed"),e.addEventListener("pointerleave",()=>e.classList.remove("is-dismissed"),{once:!0}))}function Y(e,t){if(!e)return;let s=null;const a=()=>{s&&(clearTimeout(s),s=null)};e.addEventListener("click",n=>{const o=n.target.closest("[data-react]");if(!o||!e.contains(o))return;n.preventDefault(),n.stopPropagation();const r=o.closest("[data-post-id]");F(o.closest(".reaction-wrap")),t(r,o.dataset.react)}),e.addEventListener("pointerdown",n=>{if(n.pointerType==="mouse")return;const o=n.target.closest(".btn-like");if(!o)return;const r=o.closest(".reaction-wrap");s=setTimeout(()=>r==null?void 0:r.classList.add("is-open"),350)}),["pointerup","pointerleave","pointercancel"].forEach(n=>e.addEventListener(n,a)),document.addEventListener("click",n=>{n.target.closest(".reaction-wrap")||e.querySelectorAll(".reaction-wrap.is-open").forEach(o=>o.classList.remove("is-open"))})}function q(e){var n,o,r;const t=(o=(n=e.media)==null?void 0:n[0])!=null&&o.url?`<div class="post-media"><img src="${i(e.media[0].url)}" loading="lazy" alt=""></div>`:"";if(((r=e.user)==null?void 0:r.username)==="robert_sheffield"){const l=e.description?`<p class="news-desc">${i(e.description)}</p>`:"";return`
    ...
    `}const s=e.bg_color||"#EEF2FF",a=e.font_color||(x(s)?"#1E1B4B":"#FFFFFF");return`
  ...
  `}function N(){var e;return typeof window<"u"&&((e=window.__APP__)!=null&&e.ads)&&"sponsorUrl"in window.__APP__.ads&&window.__APP__.ads.sponsorUrl||""}function U(){const e=N();return e?`<a class="newsbot-continue" href="${e}" target="_blank" rel="noopener sponsored">Continue reading…</a>`:""}function Z(e=document){e.querySelectorAll("[data-countdown]:not([data-cd-bound])").forEach(s=>{s.dataset.cdBound="1";const a=parseInt(s.dataset.countdown,10)||10,n=s.dataset.dl;if(!n)return;const o=s.querySelector("[data-cd-counter]"),r=s.querySelector("[data-cd-label]");let l=a;s.classList.add("is-counting"),s.classList.remove("is-ready"),s.disabled=!0,o&&(o.textContent=`${l}s`),r&&(r.textContent="Preparing your download…");const d=()=>{if(l-=1,l>0){o&&(o.textContent=`${l}s`),setTimeout(d,1e3);return}s.classList.remove("is-counting"),s.classList.add("is-ready"),s.disabled=!1,r&&(r.textContent="Get this book"),o&&(o.textContent="")};s.addEventListener("click",c=>{if(s.classList.contains("is-counting")){c.preventDefault();return}window.open(n,"_blank","noopener")}),setTimeout(d,1e3)})}const b="36ce0149ae6c36811ff6c54b088c483c",z=`https://pl23865704.effectivecpmnetwork.com/${b}/invoke.js`;function h(){var e,t,s;return((s=(t=(e=window.__APP__)==null?void 0:e.ads)==null?void 0:t.feed)==null?void 0:s.slotKey)||b}function R(){var e,t,s;return((s=(t=(e=window.__APP__)==null?void 0:e.ads)==null?void 0:t.feed)==null?void 0:s.slotSrc)||z}function k(e){const t=h();return`
    <div class="post-media adbot-slot" data-adbot-slot data-post-id="${e}">
      <div id="container-${t}"></div>
    </div>
  `}function J(e){var n,o,r,l;if(!e||typeof window<"u"&&((r=(o=(n=window.__APP__)==null?void 0:n.ads)==null?void 0:o.feed)==null?void 0:r.enabled)===!1)return;const t=(l=e.querySelectorAll)==null?void 0:l.call(e,"[data-adbot-slot]");if(!t||!t.length)return;const s=h(),a=R();t.forEach(d=>{if(d.dataset.adHydrated)return;d.dataset.adHydrated="1";const c=document.createElement("iframe");c.sandbox="allow-scripts allow-same-origin allow-popups",c.style.border="none",c.style.width="100%",c.style.minHeight="250px",c.style.overflow="hidden",c.scrolling="no",c.loading="lazy";const u=`<!DOCTYPE html><html><head><meta charset="utf-8"><style>body{margin:0;padding:0;display:flex;justify-content:center;align-items:center;background:transparent;overflow:hidden;}</style></head><body><div id="container-${s}"></div><script async data-cfasync="false" src="${a}"><\/script></body></html>`;c.srcdoc=u,d.innerHTML="",d.appendChild(c)})}function Q(){var e,t,s;return typeof window<"u"&&((s=(t=(e=window.__APP__)==null?void 0:e.ads)==null?void 0:t.feed)==null?void 0:s.enabled)===!1?"":`
  ...
  `}function O(e){var c;const t=(e.media||[]).filter(u=>u==null?void 0:u.url);if(((c=e.user)==null?void 0:c.username)==="daniel_whitmore")return`
      <article class="post-card image-card adbot-card" data-post-id="${e.id}">
        ${p(e,"image","Sponsored")}
        ${k(e.id)}
        ${v(e)}
      </article>
    `;if(!t.length){const u=e.description?`<div class="post-body">${i(e.description)}</div>`:"";return`
      <article class="post-card image-card" data-post-id="${e.id}">
        ${p(e,"image","Photo")}
        ${u||'<div class="post-body" style="color:#94a3b8">[image unavailable]</div>'}
        ${v(e)}
      </article>
    `}const a=e.is_adult?'<span class="adult-pill">18+</span>':"",n=e.description?`<div class="post-body">${i(e.description)}</div>`:"",o=t.length>1,r=t.map(u=>`<img class="gallery-slide" src="${i(u.url)}" loading="lazy" alt="">`).join(""),l=o?`
  ...
  `:"",d=o?`
    <div class="gallery-dots" data-gallery-dots>
      ${t.map((u,w)=>`<span class="dot${w===0?" active":""}"></span>`).join("")}
    </div>`:"";return`
    <article class="post-card image-card" data-post-id="${e.id}">
      ${p(e,"image","Photo")}
      ${n}
  ...
  `}function D(e){var n,o;const t=e.is_adult?'<span class="adult-pill">18+</span>':"",s=e.thumbnail||((o=(n=e.media)==null?void 0:n[0])==null?void 0:o.url)||"",a=e.description?`<div class="post-body">${i(e.description)}</div>`:"";return s?`
  ...
  `:`
    ...
    `}function I(e){var a;const t=(a=e.category)!=null&&a.name?`<span class="article-cat">${i(e.category.name)}</span>`:"",s=e.featured_image?`
    ...
    <article class="post-card article-card" data-post-id="${e.id}">
      ${p(e,e.is_legacy?"legacy":"article",e.is_legacy?"Legacy":"Article")}
      ${s}
  ...
  `}function V(e){const t=e.book||{},s=e.view_url||"#",a=t.cover_url?`<img src="${i(t.cover_url)}" alt="" referrerpolicy="no-referrer"
  ...
  `}function X(e){return e.type==="status"?q(e):e.type==="image"?O(e):e.type==="video"?D(e):e.type==="article"?I(e):e.type==="book"?V(e):""}function ee(e){var o,r;const t=e.querySelector("[data-gallery]"),s=(r=(o=e.parentElement)==null?void 0:o.parentElement)==null?void 0:r.querySelector("[data-gallery-dots]"),a=e.querySelector("[data-gallery-counter]");if(!t)return;const n=()=>{if(!t.clientWidth)return;const l=Math.round(t.scrollLeft/t.clientWidth);s&&s.querySelectorAll(".dot").forEach((c,u)=>c.classList.toggle("active",u===l));const d=t.children.length;a&&(a.textContent=`${l+1} / ${d}`)};t.addEventListener("scroll",n,{passive:!0})}function te(e,t){var o,r;if(!e||!t)return null;const s=t.embed_provider&&t.embed_id,a=(r=(o=t.media)==null?void 0:o[0])==null?void 0:r.url;if(s)e.innerHTML=`<div class="plyr__video-embed plyr-stage"
      ...
      </video>`;else return e.innerHTML="",null;const n=e.querySelector(".plyr-stage");return!n||typeof window.Plyr>"u"?null:new window.Plyr(n,{autoplay:!0,youtube:{noCookie:!0,rel:0,modestbranding:1}})}export{f as R,K as a,Z as b,ee as c,Y as d,X as e,F as f,i as g,Q as h,L as i,N as j,J as k,x as l,te as m,U as n,G as r,W as s};
