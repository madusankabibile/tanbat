const w=window.__APP__,g=[{key:"like",emoji:"👍",label:"Like",color:"#2563EB"},{key:"love",emoji:"❤️",label:"Love",color:"#F43F5E"},{key:"haha",emoji:"😆",label:"Haha",color:"#F59E0B"},{key:"wow",emoji:"😮",label:"Wow",color:"#F59E0B"},{key:"sad",emoji:"😢",label:"Sad",color:"#F59E0B"},{key:"angry",emoji:"😡",label:"Angry",color:"#EF4444"}],f=Object.fromEntries(g.map(t=>[t.key,t])),i=t=>String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;");function b(t){return t?`${w.urls.profileBase}/${encodeURIComponent(t)}`:"#"}function _(t){if(!t)return"";const e=Date.parse(t);if(Number.isNaN(e))return"";const s=Math.max(0,Date.now()-e),a=6e4,n=60*a,o=24*n;if(s>=5*o)return"";if(s<a)return"just now";if(s<n)return`${Math.floor(s/a)} min ago`;if(s<o)return`${Math.floor(s/n)} hr ago`;const r=Math.floor(s/o);return`${r} day${r===1?"":"s"} ago`}function L(t){if(!t||t[0]!=="#")return!0;const e=t.length===4?t.slice(1).split("").map(o=>o+o).join(""):t.slice(1,7),s=parseInt(e.slice(0,2),16),a=parseInt(e.slice(2,4),16),n=parseInt(e.slice(4,6),16);return(s*299+a*587+n*114)/1e3>=160}function x(t){const e=b(t==null?void 0:t.username),s=t!=null&&t.id?`data-user-id="${t.id}"`:"";if(t!=null&&t.profile_picture)return`<a href="${e}" ${s} data-user-link><img class="avatar" src="${i(t.profile_picture)}" alt=""></a>`;const a=i(((t==null?void 0:t.username)||(t==null?void 0:t.name)||"U").charAt(0).toUpperCase());return`<a href="${e}" ${s} data-user-link><span class="avatar">${a}</span></a>`}function u(t,e,s){const a=t.user||{},n=i(a.name||a.username||"User"),o=i(_(t.created_at_iso)),r=Number(t.views_count||0).toLocaleString(),l=b(a.username),d=a.id?`data-user-id="${a.id}"`:"";return`
    <div class="post-head">
      ${x(a)}
      <div class="who">
  ...
  `}function C(t){const e=!!t.is_owner,s=!!t.saved,a=[];return e||(a.push(m("not_interested","Not interested","Show fewer posts like this",M())),a.push(m("hide","Hide post","Remove from your feed",S()))),a.push(`
  ...
  `),e&&(a.push('<div class="post-menu-sep"></div>'),a.push(m("edit","Edit post","Update your post content",E())),a.push(m("delete","Delete post","Permanently remove this post",B(),"is-danger"))),`
  ...
  `}function Q(t){return t.type==="status"?N(t):t.type==="image"?I(t):t.type==="video"?O(t):t.type==="article"?U(t):t.type==="book"?D(t):""}function X(t){var o,r;const e=t.querySelector("[data-gallery]"),s=(r=(o=t.parentElement)==null?void 0:o.parentElement)==null?void 0:r.querySelector("[data-gallery-dots]"),a=t.querySelector("[data-gallery-counter]");if(!e)return;const n=()=>{if(!e.clientWidth)return;const l=Math.round(e.scrollLeft/e.clientWidth);s&&s.querySelectorAll(".dot").forEach((v,c)=>v.classList.toggle("active",c===l));const d=e.children.length;a&&(a.textContent=`${l+1} / ${d}`)};e.addEventListener("scroll",n,{passive:!0})}function tt(t,e){var o,r;if(!t||!e)return null;const s=e.embed_provider&&e.embed_id,a=(r=(o=e.media)==null?void 0:o[0])==null?void 0:r.url;if(s)t.innerHTML=`<div class="plyr__video-embed plyr-stage"
      ...
      </video>`;else return t.innerHTML="",null;const n=t.querySelector(".plyr-stage");return!n||typeof window.Plyr>"u"?null:new window.Plyr(n,{autoplay:!0,youtube:{noCookie:!0,rel:0,modestbranding:1}})}export{q as A,f as R,V as a,Y as b,X as c,K as d,Q as e,P as f,i as g,J as h,_ as i,Z as j,L as k,tt as m,R as n,G as r,W as s};
