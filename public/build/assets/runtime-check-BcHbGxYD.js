(function(){const l="__tanbat_adblock_dismissed_v1";function c(){const t=document.createElement("div");return t.id="AdContainer",t.className="adsbox ad-banner ad-placement ad-unit ads ad-slot adsbygoogle ad-zone pub_300x250 pub_300x250m pub_728x90 text-ad textAd text_ad text-ads text-ad-links advertisement banner_ad",t.setAttribute("data-ad-client","ca-pub-0000000000000000"),t.setAttribute("data-ad-slot","0000000000"),t.setAttribute("aria-hidden","true"),t.style.cssText="position:absolute!important;left:-9999px!important;top:-9999px!important;width:300px!important;height:250px!important;display:block!important;visibility:visible!important;",t.innerHTML="&nbsp;",document.body.appendChild(t),new Promise(o=>{setTimeout(()=>{const a=window.getComputedStyle(t),e=!t.isConnected||t.offsetParent===null||t.offsetHeight===0||t.clientHeight===0||t.offsetWidth===0||a.display==="none"||a.visibility==="hidden"||a.opacity==="0";t.remove(),o(e)},350)})}function d(t,o=2500){return new Promise(a=>{const e=document.createElement("script");e.src=t,e.async=!0;let r=!1;const n=k=>{r||(r=!0,e.remove(),a(k))};e.onload=()=>n(!1),e.onerror=()=>n(!0),document.head.appendChild(e),setTimeout(()=>n(!1),o)})}async function u(t,o=2500){try{const a=new AbortController,e=setTimeout(()=>a.abort(),o);return await fetch(t,{method:"HEAD",mode:"no-cors",cache:"no-store",signal:a.signal}),clearTimeout(e),!1}catch{return!0}}async function i(){return(await Promise.all([c(),d("https://pagead2.googlesyndication.com/pagead/show_ads.js"),d("https://securepubads.g.doubleclick.net/tag/js/gpt.js"),u("https://static.doubleclick.net/instream/ad_status.js")])).filter(Boolean).length>=2}function b(){var o;if(document.getElementById("adblock-banner"))return;const t=document.createElement("div");t.id="adblock-banner",t.setAttribute("role","dialog"),t.setAttribute("aria-modal","true"),t.setAttribute("aria-labelledby","adblock-banner-title"),t.innerHTML=`
    ...
    `,document.body.appendChild(t),document.body.classList.add("adblock-locked"),(o=document.getElementById("adblock-reload"))==null||o.addEventListener("click",()=>{location.reload()})}function p(){var t;(t=document.getElementById("adblock-banner"))==null||t.remove(),document.body.classList.remove("adblock-locked")}async function m(){try{if(sessionStorage.getItem(l)==="1")return}catch{}await i()&&b(),document.addEventListener("visibilitychange",async()=>{document.visibilityState==="visible"&&document.getElementById("adblock-banner")&&(await i()||p())})}const h=2e3;function s(){setTimeout(m,h)}document.readyState==="complete"?s():window.addEventListener("load",s,{once:!0})})();
