...
return [
    ...
    */
    ...
    'connections' => [
        ...
        // Read-only source connection pointing at the imported old Sngine
        // database. Used solely by the `legacy:import-articles` command.
        'old' => [
            'driver' => 'mysql',
            'host' => env('LEGACY_DB_HOST', env('DB_HOST', '127.0.0.1')),
            'port' => env('LEGACY_DB_PORT', env('DB_PORT', '3306')),
            'database' => env('LEGACY_DB_DATABASE', 'tanbat_old'),
